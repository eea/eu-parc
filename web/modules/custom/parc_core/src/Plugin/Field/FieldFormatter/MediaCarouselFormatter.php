...
/**
 * Plugin implementation of the 'parc_media_carousel' formatter.
 *
 * @FieldFormatter(
 *   id = "parc_media_carousel",
 *   label = @Translation("Media Carousel"),
 *   field_types = {
 *     "entity_reference"
 *   }
 * )
 */
class MediaCarouselFormatter extends EntityReferenceFormatterBase {
  ...
  /**
   * Constructs a MediaCarouselFormatter instance.
   *
